...
void Dot () {ledcWriteTone(channel, 1000); delay (shortLightTime); ledcWriteTone(channel, 0); delay (codeSpaceTime);}
void Dash () {ledcWriteTone(channel, 1000); delay (longLightTime); ledcWriteTone(channel, 0); delay (codeSpaceTime);}
